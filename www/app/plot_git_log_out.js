define(['d3'], function (d3) {
  ...
  var plot_git_log_out = function(nodes_and_arcs) {

    // console.log('plot_git_log_out:', nodes_and_arcs);
    // console.log('plot_git_log_out:', nodes_and_arcs.nodes[0]);
...
return {
    plot_git_log_out: plot_git_log_out
  };
});
